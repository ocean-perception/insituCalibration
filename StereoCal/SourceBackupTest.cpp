...
std::vector<Vec3<double>> XYZSpace(const char*, float**, double, double, int, double, double);
...
int main(int argc, char** argv){
	...
	string leftImage = "C:\\Users\\phucte\\Desktop\\jpg\\Cam51707923\\0001691.jpg";
	string rightImage = "C:\\Users\\phucte\\Desktop\\jpg\\Cam51707925\\0001691.jpg";
	string leftImage1 = "C:\\Users\\phucte\\Desktop\\jpg\\Cam51707923\\0001853.jpg";
	string rightImage1 = "C:\\Users\\phucte\\Desktop\\jpg\\Cam51707925\\0001853.jpg";
	string leftImage2 = "C:\\Users\\phucte\\Desktop\\jpg\\Cam51707923\\0002014.jpg";
	string rightImage2 = "C:\\Users\\phucte\\Desktop\\jpg\\Cam51707925\\0002014.jpg";
	string leftImage3 = "C:\\Users\\phucte\\Desktop\\jpg\\Cam51707923\\0001908.jpg";
	string rightImage3 = "C:\\Users\\phucte\\Desktop\\jpg\\Cam51707925\\0001908.jpg";
	string leftImage4 = "C:\\Users\\phucte\\Desktop\\jpg\\Cam51707923\\0001300.jpg";
	string rightImage4 = "C:\\Users\\phucte\\Desktop\\jpg\\Cam51707925\\0001300.jpg";
	string leftImage5 = "C:\\Users\\phucte\\Desktop\\jpg\\Cam51707923\\0001305.jpg";
	string rightImage5 = "C:\\Users\\phucte\\Desktop\\jpg\\Cam51707925\\0001305.jpg";
	string leftImage6 = "C:\\Users\\phucte\\Desktop\\jpg\\Cam51707923\\0001589.jpg";
	string rightImage6 = "C:\\Users\\phucte\\Desktop\\jpg\\Cam51707925\\0001589.jpg";
	string leftImage7 = "C:\\Users\\phucte\\Desktop\\jpg\\Cam51707923\\0001607.jpg";
	string rightImage7 = "C:\\Users\\phucte\\Desktop\\jpg\\Cam51707925\\0001607.jpg";
	string leftImage8 = "C:\\Users\\phucte\\Desktop\\jpg\\Cam51707923\\0001852.jpg";
	string rightImage8 = "C:\\Users\\phucte\\Desktop\\jpg\\Cam51707925\\0001852.jpg";
	string leftImage9 = "C:\\Users\\phucte\\Desktop\\jpg\\Cam51707923\\0001612.jpg";
	string rightImage9 = "C:\\Users\\phucte\\Desktop\\jpg\\Cam51707925\\0001612.jpg";


	std::vector<Vec3<double>> points = stereoLaserLineImageToPoints(leftImage, rightImage);
	std::vector<Vec3<double>> points1 = stereoLaserLineImageToPoints(leftImage1, rightImage1);
	
	std::vector<Vec3<double>> points2 = stereoLaserLineImageToPoints(leftImage2, rightImage2);
	/*
	std::vector<Vec3<double>> points3 = stereoLaserLineImageToPoints(leftImage3, rightImage3);
	std::vector<Vec3<double>> points4 = stereoLaserLineImageToPoints(leftImage4, rightImage4);
	std::vector<Vec3<double>> points5 = stereoLaserLineImageToPoints(leftImage5, rightImage5);
	std::vector<Vec3<double>> points6 = stereoLaserLineImageToPoints(leftImage6, rightImage6);
	std::vector<Vec3<double>> points7 = stereoLaserLineImageToPoints(leftImage7, rightImage7);
	std::vector<Vec3<double>> points8 = stereoLaserLineImageToPoints(leftImage8, rightImage8);
	std::vector<Vec3<double>> points9 = stereoLaserLineImageToPoints(leftImage9, rightImage9);
	*/


	std::vector<Vec3<double>> totalPoints;

	for (int i = 0; i < (int) points.size(); i++){
		totalPoints.push_back(points.at(i));
	}

	for (int i = 0; i < (int)points1.size(); i++){
		totalPoints.push_back(points1.at(i));
	}
	
	for (int i = 0; i < (int)points2.size(); i++){
		totalPoints.push_back(points2.at(i));
	}
	/*
	for (int i = 0; i < (int)points3.size(); i++){
		totalPoints.push_back(points3.at(i));
	}

	for (int i = 0; i < (int)points4.size(); i++){
		totalPoints.push_back(points4.at(i));
	}

	for (int i = 0; i < (int)points5.size(); i++){
		totalPoints.push_back(points5.at(i));
	}

	for (int i = 0; i < (int)points6.size(); i++){
		totalPoints.push_back(points6.at(i));
	}

	for (int i = 0; i < (int)points7.size(); i++){
		totalPoints.push_back(points7.at(i));
	}

	for (int i = 0; i < (int)points8.size(); i++){
		totalPoints.push_back(points8.at(i));
	}

	for (int i = 0; i < (int)points9.size(); i++){
		totalPoints.push_back(points9.at(i));
	}

	for (int i = 0; i < (int)totalPoints.size(); i++){
		totalPoints.at(i).display();
	}
	*/

	std::vector<Vec3<double>> totalSubsetPoints;
	std::vector<Vec3<double>> totalSubsetPoints1;
	std::vector<Vec3<double>> totalSubsetPoints2;
	std::vector<Vec3<double>> totalSubsetPoints3;
	std::vector<Vec3<double>> totalSubsetPoints4;
	std::vector<Vec3<double>> totalSubsetPoints5;
	std::vector<Vec3<double>> totalSubsetPoints6;
	std::vector<Vec3<double>> totalSubsetPoints7;
	std::vector<Vec3<double>> totalSubsetPoints8;
	std::vector<Vec3<double>> totalSubsetPoints9;
	...
	for (int i = 0; i < (int)totalPoints.size(); i++){
		...
		if (i % 10 == 0){
			totalSubsetPoints.push_back(totalPoints.at(i));
		}
		if (i % 10 == 1){
			totalSubsetPoints1.push_back(totalPoints.at(i));
		}
		if (i % 10 == 2){
			totalSubsetPoints2.push_back(totalPoints.at(i));
		}
		if (i % 10 == 3){
			totalSubsetPoints3.push_back(totalPoints.at(i));
		}
		if (i % 10 == 4){
			totalSubsetPoints4.push_back(totalPoints.at(i));
		}
		if (i % 10 == 5){
			totalSubsetPoints5.push_back(totalPoints.at(i));
		}
		if (i % 10 == 6){
			totalSubsetPoints6.push_back(totalPoints.at(i));
		}
		if (i % 10 == 7){
			totalSubsetPoints7.push_back(totalPoints.at(i));
		}
		if (i % 10 == 8){
			totalSubsetPoints8.push_back(totalPoints.at(i));
		}
		if (i % 10 == 9){
			totalSubsetPoints9.push_back(totalPoints.at(i));
		}
	...
	cout << "\n SubSet points 0 : \n";
	for (int i = 0; i < (int)totalSubsetPoints.size(); i++){
		totalSubsetPoints.at(i).display();
	}
	cout << "\n SubSet points 1 : \n";
	for (int i = 0; i < (int)totalSubsetPoints1.size(); i++){
		totalSubsetPoints1.at(i).display();
	}
	cout << "\n SubSet points 2 : \n";
	for (int i = 0; i < (int)totalSubsetPoints2.size(); i++){
		totalSubsetPoints2.at(i).display();
	}
	cout << "\n SubSet points 3 : \n";
	for (int i = 0; i < (int)totalSubsetPoints3.size(); i++){
		totalSubsetPoints3.at(i).display();
	}
	cout << "\n SubSet points 4 : \n";
	for (int i = 0; i < (int)totalSubsetPoints4.size(); i++){
		totalSubsetPoints4.at(i).display();
	}
	cout << "\n SubSet points 5 : \n";
	for (int i = 0; i < (int)totalSubsetPoints5.size(); i++){
		totalSubsetPoints5.at(i).display();
	}
	cout << "\n SubSet points 6 : \n";
	for (int i = 0; i < (int)totalSubsetPoints6.size(); i++){
		totalSubsetPoints6.at(i).display();
	}
	cout << "\n SubSet points 7 : \n";
	for (int i = 0; i < (int)totalSubsetPoints7.size(); i++){
		totalSubsetPoints7.at(i).display();
	}
	cout << "\n SubSet points 8 : \n";
	for (int i = 0; i < (int)totalSubsetPoints8.size(); i++){
		totalSubsetPoints8.at(i).display();
	}
	cout << "\n SubSet points 9 : \n";
	for (int i = 0; i < (int)totalSubsetPoints9.size(); i++){
		totalSubsetPoints9.at(i).display();
	}

	cout << "\n TEST Points size: " << points.size();

	cout << "\n point : ";
	points.at(0).display();
	cout << "\n Total point: ";
	totalPoints.at(0).display();


	cout << "\n Total points size: " << totalPoints.size();
	cv::Vec4d plane = planeFromPoints(totalPoints);

	/*
	cout << "\n Subset point 0 size: " << totalSubsetPoints.size();
	cv::Vec4d plane0 = planeFromPoints(totalSubsetPoints);

	cout << "\n Subset point 1 size: " << totalSubsetPoints1.size();
	cv::Vec4d plane1 = planeFromPoints(totalSubsetPoints1);

	cout << "\n Subset point 2 size: " << totalSubsetPoints2.size();
	cv::Vec4d plane2 = planeFromPoints(totalSubsetPoints2);

	cout << "\n Subset point 3 size: " << totalSubsetPoints3.size();
	cv::Vec4d plane3 = planeFromPoints(totalSubsetPoints3);

	cout << "\n Subset point 4 size: " << totalSubsetPoints4.size();
	cv::Vec4d plane4 = planeFromPoints(totalSubsetPoints4);

	cout << "\n Subset point 5 size: " << totalSubsetPoints5.size();
	cv::Vec4d plane5 = planeFromPoints(totalSubsetPoints5);

	cout << "\n Subset point 6 size: " << totalSubsetPoints6.size();
	cv::Vec4d plane6 = planeFromPoints(totalSubsetPoints6);

	cout << "\n Subset point 7 size: " << totalSubsetPoints7.size();
	cv::Vec4d plane7 = planeFromPoints(totalSubsetPoints7);

	cout << "\n Subset point 8 size: " << totalSubsetPoints8.size();
	cv::Vec4d plane8 = planeFromPoints(totalSubsetPoints8);

	cout << "\n Subset point 9 size: " << totalSubsetPoints9.size();
	cv::Vec4d plane9 = planeFromPoints(totalSubsetPoints9);
	*/
	...
	//cv::Vec4d plane = planeFromPoints(points1);
...
std::vector<Vec3<double>> stereoLaserLineImageToPoints(string leftImage, string rightImage){
	...
	std::vector<Vec3<double>> points = XYZSpace(pointCloudFilename.c_str(), laserArrayCombined, laserLineImages.focalLength, laserLineImages.baseLine, imageLeftColumns, laserLineImages.xCentre, laserLineImages.yCentre);
...
void help(char* argv[]){
 ...
 imageVar StereoCalib(
	...
	double xCentre = M1.at<double>(0, 2);
	double yCentre = M1.at<double>(1, 2);
	...
	//}
		...
		return imageVar{ img1r, img2r, focalLength, totalBaseLine, xCentre, yCentre };
...
vector<Vec3<double>> XYZSpace(const char* filename, float** laserLineArray, double focalLength, double baseLine, int imagecols, double xCentre, double yCentre){
	...
	for (int i = 0; i < imagecols; i++){
		...
		if (laserLineTop != 0 && laserLineBottom && (abs(laserLineTop - laserLineBottom)) != 0){
			...
			x = ((laserLineTop - xCentre) * z) / focalLength;

			y = ((laserLineArray[i][0]- yCentre) * z) / focalLength;
